...
import { LucideAngularModule, FileText, Building2, Car, Store, KeyRound, Wallet, CalculatorIcon, Skull, Gavel, ShoppingCart, HardHat, Server, Folder, FileSignature, IdCard, Droplets, Lightbulb } from 'lucide-angular';
...
export class ModuloDetalleComponent implements OnInit {
  ...
  modulosData: { [key: string]: any } = {
    ...
    'thps': {
      nombre: 'THPS - Tasa Higiene, Profilaxis y Seguridad',
